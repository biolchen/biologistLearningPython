...
dat='https://raw.githubusercontent.com/gVallverdu/cookbook/master/Evolution_et_structure_de_la_population/Evolution_structure_population.csv'
...
squarify.plot(
    sizes=[100,13,22,35,5], 
    label=["group A", "group B", "group C", "group D", "group E"], alpha=.7 )
plt.axis('off')
plt.show()
